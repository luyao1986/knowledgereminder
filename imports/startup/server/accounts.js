...
const name = 'Knowledge Helper';
const email = '<adonis.melody@gmail.com>';
const from = `${name} ${email}`;
const emailTemplates = Accounts.emailTemplates;

//all the accounts related code is from base https://github.com/themeteorchef/base.git which is a very good start
